...
Priorize trechos que tenham uma tese ou conflito identificável nos primeiros segundos, desenvolvimento com posicionamento/proposta/dado/denúncia e uma conclusão clara. Classifique o formato como confronto/reação, proposta/programa, dado/denúncia, discurso/posicionamento ou mobilização. Inclua o setup necessário para o espectador entender quem está sendo criticado, qual é o assunto e qual é a consequência. Não invente fatos, não transforme opinião em fato e não atribua uma fala a um participante sem evidência na transcrição. Prefira cortes autossuficientes, com energia, especificidade e uma frase final forte; penalize abertura no meio da frase, pronomes sem antecedente, acusações sem contexto e encerramento antes da conclusão."""
