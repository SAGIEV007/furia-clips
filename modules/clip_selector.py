...
class ClipSelector:
    ...
    def select_clips(self, transcription, energy_profile=None, user_context="",
        ...
        # O ciclo experimental desligou isto por padrão, deixando o CHUB como
        # memória descritiva. É uma decisão de política editorial, não um
        # conserto de corte — e ele pediu a melhor capacidade de CORTE, não uma
        # mudança no que o CHUB pode propor. Desligar tiraria dele, sem aviso,
        # uma fonte de candidatos que ele já vinha recebendo. Fica ligado; o
        # ajuste existe para quem quiser desligar.
        guided_selection_enabled = bool(settings.get("campaign_hub_guided_selection", True))
        ...
        self._candidate_diagnostics = {
            ...
            "campaign_hub_guided_selection_enabled": bool(settings.get("campaign_hub_guided_selection", True)),
