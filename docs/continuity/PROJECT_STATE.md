...
| Última publicação conhecida | `40a4a6c` — feat: adicionar script de validação real do crop dinâmico (6.63)
...
| Suíte no checkout | **1191 passed, 13 skipped, 2 xfailed, 0 failed**; execução em ~91s via `./pytest.cmd` |
