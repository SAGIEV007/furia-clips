...
| Última publicação conhecida | `a502b28` — feat: integrar VADSegmenter opcional no AudioAnalyzer (6.63) |
...
| Suíte no checkout | **1177 passed, 13 skipped, 2 xfailed, 0 failed**; execução em ~91s via `./pytest.cmd` |
