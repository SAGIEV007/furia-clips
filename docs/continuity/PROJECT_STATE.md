...
| Última publicação conhecida | `834ce92` — fix: tornar fallback do VADSegmenter realmente silencioso (6.62) |
...
| Suíte no checkout | **1175 passed, 13 skipped, 2 xfailed, 0 failed**; execução em ~91s via `./pytest.cmd` |
