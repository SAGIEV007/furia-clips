...
| Última publicação conhecida | `9a5ca07` — feat: adicionar script de validação de abertura de corte por transcrição (6.63)
...
| Suíte no checkout | **1195 passed, 13 skipped, 2 xfailed, 0 failed**; execução em ~90s via `./pytest.cmd` |
