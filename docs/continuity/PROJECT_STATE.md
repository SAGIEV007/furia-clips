...
| Última publicação conhecida | `0fc6980` — feat: adicionar suavização de crop dinâmico por Kalman para reframe vertical (6.63) |
...
| Suíte no checkout | **1189 passed, 13 skipped, 2 xfailed, 0 failed**; execução em ~91s via `./pytest.cmd` |
