...
| Última publicação conhecida | `9d36552` — `fix: pytest.cmd usa venv local do projeto` |
...
| Suíte no checkout | 1163 aprovados, 13 ignorados, 2 xfailed, 0 failed; execução em ~90s via `./pytest.cmd` |
