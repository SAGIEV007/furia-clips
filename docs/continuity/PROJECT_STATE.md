...
| Última publicação conhecida | `76bdd34` — fix: skip VAD segmentation on videos without audio (6.63) |
...
| Suíte no checkout | **1178 passed, 13 skipped, 2 xfailed, 0 failed**; execução em ~91s via `./pytest.cmd` |
