...
## Nova janela autenticada — perfil principal — ciclo seguinte

A grade autenticada do perfil principal exibiu novamente 3.503 posts e 2,3M seguidores. Duas rolagens normais acrescentaram os seguintes Reels visíveis: `Db8D9DxNnUX` — 402K; `Db6qoCUBulc` — 1M; `Db6g5dfteDn` — 644K; `Db6XRaAtNTR` — 395K; `Db56l1MNBHb` — 2,7M; `Db5lhGWt97n` — 512K; `Db4BVlMt6hO` — 4,5M; `Db32p6PNW_8` — 442K; `Db3fEHeNPOU` — 806K; `Db3IpxTNmhQ` — 1,2M; `Db27BYYtsjr` — 1M; e `Db16NV_tyH-` — 525K.

A amostra visual mostrou pelo menos quatro famílias que precisam permanecer distintas no ranking: talking head com texto amarelo; entrevista/podcast em preto e branco; reação a TV ou autoridade com evidência em split-screen; e peça institucional/evento com cartela, palco ou imagem externa. Também apareceram cards com frases destacadas em amarelo, vermelho, branco e magenta. A regra operacional derivada é preservar composição quando a tese depende de contexto externo, cartela, plateia, pessoa entrevistada ou documento; reenquadrar só quando o locutor único continua inteligível após o crop. A contagem de views é um snapshot observado e deve sempre carregar data de coleta.

### Caso detalhado: `Db4BVlMt6hO` — 4,5M de views observadas na grade

A publicação aparece como **Edited · 3d** e usa **Original audio**. A headline visual abre com “O vídeo que eles não querem que você veja”, em branco sobre fundo preto, seguida por uma evidência visual direta — prato de comida com a marcação “2023” — e assinatura discreta “Renan Santos”. A caption acessível é “O vídeo que eles não querem que você veja. Siga @renansantosmbl”. Nos comentários visíveis, aparecem respostas de apoio e pedidos de compartilhamento, incluindo “Com Renan Santos o futuro do Brasil será GLORIOSO!”, “Contamos com você, presida!” e “Compartilhem, Renan Santos Presidente”, com 2.097 likes no comentário destacado e vários comentários entre 220 e 664 likes. A publicação é um exemplo de **hook de curiosidade + evidência visual concreta + CTA de distribuição**, não uma prova causal de que qualquer um desses elementos isoladamente produziu o alcance.

Regra segura derivada: quando o trecho selecionado contém objeto, documento, tela ou imagem externa que sustenta a tese, o ranking deve elevar a necessidade de preservação da composição original e sugerir headline curta de curiosidade somente se a transcrição ou o contexto também explicarem o referente. A presença de áudio original e edição textual deve ser registrada como característica do formato, não como sinal privado de performance.

## Nova janela autenticada — perfil reserva — ciclo seguinte

A grade autenticada do perfil reserva exibiu 370 posts e 128K seguidores. A janela atual mostrou: `DcB5mV1PCg2` — 36,2K; `DcB2qfyipJk` — 4.368; `DcBxi03ET-L` — 4.637; `DcBsa3VBIrr` — 82,7K; `DcBlg0zjdNE` — 11,9K; `DcBg61QE06m` — 20K; `DcBdVrHElHR` — 9.706; `DcAL9ZSResM` — 170K; `Db_4A6IDX1O` — 158K; `Db_svcovjix` — 129K; `Db_qtXRgm1b` — 83K; e `Db_mfm5ihyd` — 17K.

Visualmente, essa janela reforça o uso de três famílias: card institucional com data/local e identidade da Missão; resposta a comentário ou a publicação externa com headline branca/preta; e talking head/reação com texto amarelo ou vermelho sobre o vídeo. Também aparecem recortes de tela, postagens do X, fachadas e cartazes como evidência. A regra editorial aplicada ao backlog é classificar “resposta”, “evidência externa”, “institucional” e “talking head” como famílias distintas, pois cada uma exige uma política de crop e de texto de arte diferente. A contagem continua sendo apenas o alcance exibido no momento da coleta.
