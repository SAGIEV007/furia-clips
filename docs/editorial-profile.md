...
Antes de escolher o subtipo político, o sistema identifica a família dominante do momento: **politico**, **humor**, **reacao**, **bastidor**, **descontraido** ou **conversa**. Essa camada impede que uma piada, uma reação ou uma história pessoal seja artificialmente pontuada como discurso político apenas porque o canal de referência tem orientação política. A família aparece em `editorial_family` e recebe `editorial_family_fit` no ranking.
...
A aplicação envia aos backends de IA a seguinte orientação conceitual: selecionar cortes com tese, reação, humor, história ou conflito identificável; classificar primeiro a família editorial e, quando aplicável, o subtipo político; incluir o setup necessário; não inventar fatos; não transformar opinião em fato; não atribuir falas sem evidência; e preferir cortes autossuficientes com especificidade, energia e uma frase final forte.
